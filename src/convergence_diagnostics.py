...
parameters.  Results are written to ``outputs/figures/convergence`` and printed
on the console.  If the pickled draws are not available (for example because
Git LFS files were not fetched), the script will skip the respective model.
"""
